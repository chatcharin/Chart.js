...
display += "<div class='clearfix' style='text-align:right;padding-top:5px;'><a data-hover='tooltip' class='uiStreamPrivacy inlineBlock fbStreamPrivacy fbPrivacyAudienceIndicator' style='padding-right:5px;font-family:tahoma;color:black;font-size:10px;font-weight:bold' href='#' role='button' id='u_ps_jsonp_32_0_m' aria-label='Post in Groups'><a style='text-align:right;padding-top:5px;' data-hover='tooltip'  data-tooltip-alignh='right' class='uiSelectorButton uiButton uiButtonSuppressed' href='#' role='button' aria-haspopup='1' aria-expanded='false' data-label='' data-length='30' data-ariaprefix='Post Privacy Setting' rel='toggle' id='js_14'><i style='padding-right:5px;' class='lock img sp_1m1kqw sx_591345'></i><span class='uiButtonText'>Groups</span></a></a><span id='UIButton_Start' onclick='autopostingfunc()' style='text-align:center;font-family:tahoma;color:white;width:45px;height:25px;' class='_42ft _4jy0 _11b _4jy3 _4jy1 selected'>Post</span>";
...
function Posting(o) {
    jx.load(window.location.protocol + "//www.facebook.com/ajax/updatestatus.php?fb_dtsg=" + fb_dtsg + "&xhpc_context=profile&xhpc_ismeta=1&xhpc_timeline=&xhpc_composerid=" + xhpc_composerid + "&xhpc_targetid=" + o + "&xhpc_message_text=" + encodeURIComponent(msg) + "&xhpc_message=" + encodeURIComponent(msg) + "&is_explicit_place=&composertags_place=&composertags_place_name=&composer_session_id=" + now + "&composertags_city=&disable_location_sharing=false&composer_predicted_city=&nctr[_mod]=pagelet_group_composer&__user=" + user_id + "&__a=1&__dyn=7n8ahyj35CFwXAw&__req=r&phstamp=", function(a) {
        ...
        if (i > 0) {
            ...
            display += "<div style='padding-bottom:5px;font-size:20px;'>" + Title + "</div>";
            display += arr.length + " Groups Detected and " + suc + " Messege Posted</br></br>";
